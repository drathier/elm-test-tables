...
andThenTests =
  describe "Monad laws"
    ...
    , describe "Set.andThen"
        [ andThenv1 Set.singleton Set.concatMap (Fuzz.list >> Fuzz.map Set.fromList)
        , andThenv2 Set.singleton Set.concatMap (Fuzz.list >> Fuzz.map Set.fromList)
        , andThenv3 Set.singleton Set.concatMap (Fuzz.list >> Fuzz.map Set.fromList)
        ]
    ]
